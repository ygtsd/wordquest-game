    ...
    units: [
      {
        ...
        sentences: [
          { q: "___ your book, please.", options: ["Open", "Eat", "Drink"], a: "Open" },
          { q: "Please be ___ in class.", options: ["loud", "quiet", "fast"], a: "quiet" },
          { q: "___ up when the teacher comes.", options: ["Stand", "Sleep", "Run"], a: "Stand" },
          { q: "Please ___ to your teacher.", options: ["listen", "shout", "jump"], a: "listen" },
        ],
      },
      {
        id: 2,
        ...
        sentences: [
          { q: "I am from Turkey. I am ___.", options: ["Turkish", "German", "French"], a: "Turkish" },
          { q: "She is from Japan. She is ___.", options: ["Italian", "Japanese", "Spanish"], a: "Japanese" },
          { q: "He is from America. He is ___.", options: ["American", "English", "Turkish"], a: "American" },
          { q: "They are from France. They are ___.", options: ["German", "French", "Spanish"], a: "French" },
        ],
      },
      {
        id: 3,
        ...
        sentences: [
          { q: "Superman is very ___.", options: ["strong", "slow", "sad"], a: "strong" },
          { q: "A tortoise is ___.", options: ["fast", "slow", "tall"], a: "slow" },
          { q: "Mickey Mouse is ___.", options: ["funny", "angry", "sad"], a: "funny" },
          { q: "A lion is ___.", options: ["kind", "brave", "slow"], a: "brave" },
        ],
      },
      {
        id: 4,
        ...
        sentences: [
          { q: "I ___ football with my friends.", options: ["play", "eat", "read"], a: "play" },
          { q: "She ___ to music every day.", options: ["listens", "dances", "sings"], a: "listens" },
          { q: "We ___ TV in the evening.", options: ["watch", "ride", "read"], a: "watch" },
          { q: "They ___ a bike in the park.", options: ["play", "ride", "sing"], a: "ride" },
        ],
      },
      {
        id: 5,
        ...
        sentences: [
          { q: "I ___ up at 7 o'clock.", options: ["wake", "go", "have"], a: "wake" },
          { q: "We ___ breakfast at 8.", options: ["go", "have", "wake"], a: "have" },
          { q: "She ___ her homework after school.", options: ["does", "goes", "eats"], a: "does" },
          { q: "I ___ my teeth before bed.", options: ["wash", "brush", "eat"], a: "brush" },
        ],
      },
      {
        id: 6,
        ...
        sentences: [
          { q: "A stone is ___. It sinks.", options: ["light", "heavy", "small"], a: "heavy" },
          { q: "A leaf can ___ on water.", options: ["sink", "float", "eat"], a: "float" },
          { q: "A ___ can pull metal.", options: ["magnet", "book", "pencil"], a: "magnet" },
          { q: "We do an ___ in science class.", options: ["experiment", "apple", "exam"], a: "experiment" },
        ],
      },
      {
        id: 7,
        ...
        sentences: [
          { q: "A ___ helps sick people.", options: ["doctor", "farmer", "driver"], a: "doctor" },
          { q: "A ___ teaches students.", options: ["cook", "teacher", "nurse"], a: "teacher" },
          { q: "A ___ puts out fires.", options: ["firefighter", "driver", "doctor"], a: "firefighter" },
          { q: "A ___ drives a bus or taxi.", options: ["farmer", "cook", "driver"], a: "driver" },
        ],
      },
      {
        id: 8,
        ...
        sentences: [
          { q: "It's cold! Wear your ___.", options: ["t-shirt", "coat", "shorts"], a: "coat" },
          { q: "I wear ___ on my feet.", options: ["shoes", "hat", "dress"], a: "shoes" },
          { q: "She wears a pink ___ to the party.", options: ["socks", "dress", "shoes"], a: "dress" },
          { q: "Put a ___ on your head in the sun.", options: ["hat", "shoe", "sock"], a: "hat" },
        ],
      },
    ],
  },
